...
Scale AI was the dominant AI data-labeling vendor to frontier labs until **June 2025, when Meta acquired a 49% stake for $14.3B** and installed founder Alexandr Wang inside Meta to lead its new superintelligence effort. The deal was widely read by rival labs as ending Scale's neutrality: because frontier labs route their most sensitive asset (the data shaping unreleased models) through their data vendor, competitors sending data through a Meta-controlled Scale became untenable. *(HIGH — corroborated across Teahose, Value Add VC, Contrary Research via search)*
...
Scale runs an explicit, well-documented **[Data Partnership](https://scale.com/data-partnership)** program: buys de-identified structured records from companies' existing systems (data warehouses, Slack/Teams/email, docs, Jira/Asana/Notion, Salesforce/HubSpot/Workday), prefers companies with 40+ employees, frames deals as recurring rather than one-time, and states an illustrative **$10K–$1M+ per-partnership** value range plus a flat **$10,000 referral bonus** for a successful company introduction. This is a more concretely quantified public offer than either Mercor's or Handshake's equivalent programs (Mercor discloses only its $100K referral ceiling with no base-deal range; Handshake discloses no figures at all). *(HIGH — verified via direct fetch)* See `../SELLING-STRATEGY.md` for the full cross-company comparison.
