...
| Entity | Status | Value | File |
|---|---|---|---|
| Mercor AI Vetting/Assessment Engine | RESEARCHED (light) | HIGH | [Products/Mercor-AI-Vetting-Assessment.md](Products/Mercor-AI-Vetting-Assessment.md) |
| Mercor Post-Training Data Suite (RLHF/SFT/Rubrics/RL Envs/APEX) | RESEARCHED | CRITICAL | [Products/Mercor-Post-Training-Suite.md](Products/Mercor-Post-Training-Suite.md) |
...
**Breadth gate for Products: MET** (3 RESEARCHED). All entries specific to Mercor's own stack — competitor product lines are the priority for iteration 2.
...
**Breadth gate for Trends: MET** (3 RESEARCHED).
