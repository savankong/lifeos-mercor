...
| Company | Name | Role | LinkedIn | Relevance | Confidence |
|---|---|---|---|---|---|
| **Handshake AI** | **Yang Zhao** | Chief Business Officer | [linkedin.com/in/yangczhao](https://www.linkedin.com/in/yangczhao/) | Explicitly "leads all business and operations development" for Handshake AI — the most directly relevant named contact found in this entire pass, for any of the seven companies. Ex-Scale AI (4 years, Head of Product Deployment and Operations); before that, growth/strategy lead at Zumper. MBA, Haas School of Business (UC Berkeley); BA, Cornell. Joined Handshake AI in January 2025. Full profile: `../People/Yang-Zhao.md` | HIGH on role/bio (verified via direct fetch of Handshake's announcement); MED on the LinkedIn URL match (search-snippet cross-reference, not independently fetched — LinkedIn blocks automated access) |
| **Handshake AI** | **Sahil Bhaiwala** | Chief Strategy and Innovation Officer | **Not found** — no canonical linkedin.com/in/ URL surfaced; see [TheOrg profile](https://theorg.com/org/handshake/org-chart/sahil-bhaiwala) instead | Oversees long-term strategy, market positioning, and innovation for the AI org — a secondary contact if Zhao isn't reachable. Also ex-Scale AI (GM, Director of Product & AI, ran the International Public Sector unit) and ex-Bain & Company. Full profile: `../People/Sahil-Bhaiwala.md` | HIGH on role/bio (same source); no LinkedIn URL found — not guessed |
| **Scale AI** | **Francis deSouza** | CEO (effective Aug 10, 2026) | Not researched this pass | Too senior to be a first-touch BD contact for a small deal, but the name to know given how recent the change is — see Leadership update in `Companies/Scale-AI.md` | HIGH — verified via Scale's own announcement |
| **Scale AI** | Matt Park | Chief Business Officer (dated) | Not researched this pass | Multiple people-search sources list this title but date the tenure "2017 to 2024" — **likely no longer current**. Not recommended as an active target without independent confirmation. | LOW / possibly outdated |
| **Surge AI** | **Edwin Chen** | Founder & CEO | [linkedin.com/in/edwinzchen](https://www.linkedin.com/in/edwinzchen/) | With no distinct BD organization found and only ~110–121 employees total, Chen himself is plausibly still the actual decision-maker for anything beyond routine individual hiring — consistent with the "no self-serve program" finding above. Full profile: `../People/Edwin-Chen.md` | MED — inference from company size, not a direct statement that Chen personally handles this; LinkedIn URL is MED confidence (search-snippet title match, not independently fetched) |
